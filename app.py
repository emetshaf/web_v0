...
@app.route('/admin/edit_narrator/<narrator_id>', methods=['GET', 'POST'], strict_slashes=False)
...
@app.route('/admin/edit_user/<user_id>', methods=['GET', 'POST'], strict_slashes=False)
